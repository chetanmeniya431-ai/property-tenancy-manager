                ...
                <div class="flex items-start justify-between p-6 pb-0">
                    <div>
                        <div class="flex items-center gap-2 mb-1">
                            ...
                            <span class="text-xs font-medium text-sky-600 uppercase tracking-wide">Demo Mode</span>
                        </div>
                ...
                <div class="p-6">
                    @if($submitted)
                        <div class="flex flex-col items-center py-6 text-center">
                            <div class="flex h-12 w-12 items-center justify-center rounded-full bg-sky-100 mb-4">
                                <svg class="h-6 w-6 text-sky-600" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                            ...
                            <button wire:click="close" class="mt-4 rounded-lg bg-sky-600 px-4 py-2 text-sm font-semibold text-white hover:bg-sky-700">
                        ...
                        <form wire:submit="submit" class="space-y-4">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input wire:model="company" type="text" placeholder="Acme Properties Ltd"
                                           class="block w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-sky-500 focus:ring-1 focus:ring-sky-500">
                                </div>
                                <div>
                            ...
                            <div>
                                ...
                                <textarea wire:model="message" rows="3"
                                          ...
                                          class="block w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-sky-500 focus:ring-1 focus:ring-sky-500"></textarea>
                                @error('message') <p class="mt-1 text-xs text-red-600">{{ $message }}</p> @enderror
                            </div>
                            <div class="flex items-center gap-3 pt-1">
                                <button type="submit"
                                        class="flex-1 rounded-lg bg-sky-600 px-4 py-2.5 text-sm font-semibold text-white hover:bg-sky-700 transition-colors"
